...
const MainPage = () => {
  ...
  useEffect(() => {
    window.addEventListener("scroll", () =>
      setIsDark(window.pageYOffset !== 0)
    );
  }, []);
  const headerName =
    "nk-header page-header is-transparent is-sticky is-shrink is-dark " +
    (isDark ? "has-fixed" : "");
  return (
    <body className="nk-body body-wider theme-dark mode-onepage">
      <div className="nk-wrap">
                      ...
                      <div className="col-lg-6">
                        <div className="banner-caption wide-auto text-center text-lg-left">
                          ...
                          <div className="cpn-text cpn-text-s1">
                            <p className="lead">
                              10.000 Rogue Reindeer on the Ethereum Blockchain
                            </p>
                          </div>
                          <div id="mint-box" className="cpn-btns">
                            ...
                            >
                              ...
                              <a href="" className="btn btn-grad btn-round">
                                23 december 2021 07:00 PM UTC +1
                              </a>
                            </div>
                          </div>
                          <div className="cpn-social">
                            <ul className="social">
                              <li>
                                <a
                                  target="_blank"
                                  href="https://discord.gg/QrFNGhKVDV"
                                >
        ...
        <main className="nk-pages">
                ...
                >
                  ...
                  <div className="col-sm-10 col-md-6 text-center text-md-left">
                    <div className="nk-block-text">
                      <h4 className="title title-lg">
                        What is Rogue Reindeer?
                      </h4>
                      <p className="lead">
                        Everybody knows that Christmas presents from Santa are a
                        huge hustle, paid for by the parents themselves. The
                        rich parents pay Santa a lot of money to leave a buck
                        load of presents under the Christmas tree, that joyful
                        morning. <br />
                        <br />
                        Meanwhile, less fortunate parents can't pay the huge
                        fees that Santa asks for his service, even though their
                        kids deserve it just as much. Santa's Reindeer have been
                        doing the brunt work for years now, flying him around in
                        his huge golden sled, witnessing this injustice.
                        <br />
                        <br />
                        They've had enough. 10.000 Rogue Reindeer have escaped
                        Santa's headquarters, soaring the Ethereum blockchain
                        with a new purpose: to support the children who need it.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section
            className="section section-roadmap bg-theme tc-light"
            id="roadmap"
          >
            <div className="container">
              <div className="section-head text-center wide-auto">
                ...
                <p className="lead">
                  The primary value of Rogue Reindeer is the high quality art.
                  We wanted to develop an original and iconic project exclusive
                  for the Ethereum blockchain that holders can be proud of.
                  However, we are much more than just a pretty face.
                  <br />
                </p>
              </div>
                    ...
                    <div className="roadmap-wrap">
                      ...
                      <div className="roadmap roadmap-left">
                        <div className="roadmap-step">
                          ...
                          <p>
                            Upon selling out{" "}
                            <b> we will distribute 10% of the proceeds</b> from
                            our mint to charitable organizations. The first one
                            will be{" "}
                            <u>
                              <b>
                                <a href="https://www.pelicano.be">
                                  STICHTING PELICANO
                                </a>
                              </b>
                            </u>
                      ...
                      <div className="roadmap roadmap-left">
                        <div className="roadmap-step">
                          ...
                          <p>
                            We believe in value first, mint later. By growing
                            the Rogue Reindeer brand, we want to bring that
                            value. Value to the community as holders. Value to
                            the people that support us, but most importantly: to
                      ...
                      <div className="roadmap roadmap-right">
                        <div className="roadmap-step">
                          ...
                          <p>
                            ...
                            with other projects in the space. Our{" "}
                            <u>
                              <b>
                                <a href="https://www.instagram.com/piocomic/">
                                  artist Pío
                                </a>
                              </b>
                            </u>{" "}
                ...
                >
                  <div className="col-xl-8 col-lg-10">
                    <ul className="nav tab-nav tab-nav-line mgb-r">
                      ...
                      <li>
                        <a data-toggle="tab" href="#about-nfts">
                          About NFTs
                        </a>
                      </li>
                    </ul>
                          ...
                          <div className="accordion-item accordion-item-s4 bg-light">
                            ...
                            >
                              <div className="accordion-content">
                                ...
                                Reindeer collection. We aim to be an inclusive
                                project that many people can see themselves in
                                and proudly use as their PFP as they navigate in
                                the space and in the upcoming chosen Metaverse.
                                <br />
                              </div>
                            </div>
                            <h5
                            ...
                            >
                              <div className="accordion-content">
                                ...
                                Twitter and we would be happy to help you out.
                                <br />
                              </div>
                            </div>
                            <h5
                            ...
                            >
                              <div className="accordion-content">
                                There are a lot of opportunities in the Crypto
                                and NFT space. Finding much success ourselves,
                                the first thing we could think about doing was
                                spreading this opportunity to as many people as
                                possible while also donating to children in
                                need. We wanted to create a PFP project that had
                                unique, beautiful and distinct art that we could
                                build an inclusive and supportive community
                                around. We want to share knowledge and help all
                                our community members grow.
                                <br />
                              </div>
                            </div>
                            <h5
                            ...
                            >
                              <div className="accordion-content">
                                All of our art was lovingly made by our own{" "}
                                <u>
                                  <b>
                                    <a href="https://www.instagram.com/piocomic/">
                                      artist Pío
                                ...
                                from scratch, by hand. The aesthetic was
                                achieved by designing unique themed traits,
                                drawing inspiration from popculture and memes.
                                <br />
                              </div>
                            </div>
                            <h5
                            ...
                            >
                              <div className="accordion-content">
                                ...
                                <u>
                                  <b>
                                    <a href="https://discord.gg/QrFNGhKVDV">
                                      Discord
                                    </a>
                                  </b>
                                </u>{" "}
                                ...
                                <u>
                                  <b>
                                    <a href=" https://twitter.com/Rogue_Reindeer/">
                                      Twitter
                                    </a>
                                  </b>
                                </u>
                                . We are happy to help you answer any question
                                you might have!
                                <br />
                              </div>
                            </div>
                      ...
                      <div className="tab-pane fade" id="about-nfts">
                        <div className="accordion accordion-faq" id="faq-68">
                            ...
                            >
                              <div className="accordion-content">
                                <p>
                                  ...
                                  albums, tickets to the game and more. Anything
                                  that exists online can be purchased as an NFT,
                                  theoretically.
                                </p>
                                <p>
                                  NFTs are different from cryptocurrencies
                                  because they’re not interchangeable. Think of
                                  Pokémon cards: You can trade them, but a
                                  Magikarp is not the same as a holographic
                                  Charizard. But a Bitcoin is indistinguishable
                                  from another Bitcoin.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="accordion-item accordion-item-s4 bg-light">
                            ...
                            >
                              Which wallet will I be able to use to mint an
                              Rogue Reindeer NFT?
                              <span className="accordion-icon accordion-icon-s2" />
                            </h5>
                            <div
                            ...
                            >
                              <div className="accordion-content">
                                <p>
                                  As MetaMask is the most popular wallet, we
                                  have chosen MetaMask as our go-to wallet.
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="accordion-item accordion-item-s4 bg-light">
                            ...
                            >
                              How can you ensure distribution of mints is
                              random?
                              <span className="accordion-icon accordion-icon-s2" />
                            </h5>
                            <div
